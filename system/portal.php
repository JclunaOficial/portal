...
// asingar la zona horaria predeterminada
date_default_timezone_set(DEFAULT_TIME_ZONE);

// define la ruta general de las clases
define('APP_CLASS', APP_DIR . 'classes' . DS);
...
// define las variables de sesión para el tema (THEME)
define('THEME_NAME', '__themeName');        // nombre del tema a utilizar
define('THEME_NAVBAR', '__themeNavbar');    // estilo para la barra de navegación

/**
 * Clase principal del framework Portal
 */
final class Portal {

    // información básico del framework; NO REMOVER!!! 
    const Product = 'Portal';
    const Version = '2016.06.15.1411';
    ...
    /**
     * Crear una instancia del tipo Portal
     */
    ...
    public function run() {
        ...
        $loginReady = Session::getValue(LOGIN_READY, false);
        if ($loginReady == false && $obj->getLoginRequired()) {
    ...
    /**
     * Cargar una clase al contexto de la aplicación
     * @param string $className nombre de la clase a cargar
     */
    public static function loadClass($className) {
        // la clase de debe localizar en el folder /application/classes/
        require_once(UString::replacePipe(APP_CLASS . $className . '.php'));
    }

    // validar el controlador solicitado
    ...
    // cargar los helpers de la aplicación
    ...
    // obtener los segementos de la solicitud
    ...
    // localizar el controlador y la acción solicitada
